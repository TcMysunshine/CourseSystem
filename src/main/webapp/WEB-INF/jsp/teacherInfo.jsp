                            ...
                            <div class="content">
                                <div class="author">
                                    ...
                                    <h4 class="title">${teacherInfo.teacherName}<br/>
                                        <a href="#">
                                            <small>${teacherInfo.teacherEmail}</small>
                                        </a>
                                    </h4>
                                </div>
                                <div class="author">
                            ...
                            <div class="text-center">
                                <div class="row">
                                    <div class="col-md-3 col-md-offset-1">
                                        <h5>学院<br/>
                                            <small>${teacherInfo.teacherDepartment}</small>
                                        </h5>
                                    </div>
                                    <div class="col-md-4">
                                        <h5>职称<br/>
                                            <small>${teacherInfo.teacherDegree}</small>
                                        </h5>
                                    </div>
                                    <div class="col-md-3">
                                        <h5>办公室<br/>
                                            <small>${teacherInfo.teacherOffice}</small>
                                        </h5>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" disabled
                                                       placeholder="id" value="${teacherInfo.teacherCount}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input "
                                                       name="teacherEmail" placeholder="Username"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>民族</label>
                                                <input type="text" class="form-control border-input "
                                                       name="teacherNationality" placeholder="Nationality"
                                                       value="${teacherInfo.teacherNationality}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>性别</label>
                                                <input type="text" class="form-control border-input " name="teacherSex"
                                                       placeholder="Sex"
                                                <c:if test="${teacherInfo.teacherSex==1}"> value="男"</c:if>
                                                <c:if test="${teacherInfo.teacherSex==2}"> value="女"</c:if>>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>年龄</label>
                                                <input type="text" class="form-control border-input " name="teacherAge"
                                                       placeholder="age" value="${teacherInfo.teacherAge}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>地址</label>
                                                <input type="text" class="form-control border-input "
                                                       name="teacherAddress" placeholder="Home Address"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>联系方式</label>
                                                <input type="text" class="form-control border-input "
                                                       name="teacherPhone" placeholder="Phone"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>入学时间</label>
                                                <input type="text" class="form-control border-input"
                                                       placeholder="createTime" disabled
                                                       value="${teacherInfo.teacherCreatetime}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control border-input "
                                                          ...
                                                          value="Mike">${teacherInfo.teacherIntroduce}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text-center">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" placeholder="请输入新密码" name="newPass"
                                   id="newPass">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="password" class="form-control" placeholder="请确认新密码" name="confirmPass"
                                   id="confirmPass">
                        </div>
                    </div>
                </form>
